...
//     try {
//       if (editingId) {
//         await axios.put(`http://localhost:5000/api/purchases/${editingId}`, payload);
//         setEditingId(null);
//       } else {
...
//       <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Purchases (Admin)</h1>
          ...
          <tbody className="divide-y divide-gray-100">
            {purchases.map((p, idx) => (
              ...
              >
                ...
                <td className="px-4 py-2 flex flex-wrap gap-2">
                  <button
                    className="px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow hover:scale-105 transition"
                    onClick={() => handleEdit(p)}
                  >
                    Edit
                  </button>
                  <button
                    className="px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-red-500 to-orange-500 text-white shadow hover:scale-105 transition"
                    onClick={() => handleDelete(p._id)}
                  >
                    Delete
                  </button>
