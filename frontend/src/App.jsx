...
import { BrowserRouter as Router, Routes, Route, Link, Navigate, useLocation } from "react-router-dom";
import { useState, useEffect } from "react";
import { LayoutDashboard, ShoppingCart, DollarSign, ClipboardList, Shuffle, User, Menu } from "lucide-react";
...
function Navbar({ user, setUser }) {
  ...
  return (
    <nav className="bg-gray-900 text-white px-6 py-3 flex justify-between items-center shadow-lg">
      {/* Logo / Brand */}
      <div className="font-bold text-lg">Military Dashboard</div>
